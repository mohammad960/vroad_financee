...
var btn1 = document.getElementById("cancel1");
var btn2 = document.getElementById("cancel2");
var btn3 = document.getElementById("cancel3");
var btn4 = document.getElementById("cancel4");
...
var modal_dash = document.getElementById("dashboardModel");
var btn_dash = document.getElementById("last_dashboard");
var close_ = document.getElementById("close_dash");

btn_dash.onclick = function() {
  modal_dash.style.display = "block";
}

close_.onclick = function() {
	
  modal_dash.style.display = "none";
}
