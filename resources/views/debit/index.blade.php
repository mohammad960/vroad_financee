...
<div Style="background-color:white;border-top:solid 3px white;padding:2%;">
    ...
    <button id="btnFiterSubmitSearch" onClick="filterTime()" class="btn btn-primary" style="float:right;color:black;background-color:white;"> <i class="fa fa-paper-plane" aria-hidden="true"></i>  Submit </button>
	</br>
