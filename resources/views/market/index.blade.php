...
<a href="{{ route('market.create') }}" class="btn btn-primary" style="float:right;color:black;background-color:white;"> <i class="fa fa-plus" aria-hidden="true"></i>  Create </a>
 </div>
</br>
</br>
