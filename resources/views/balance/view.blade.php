		...
		<p><strong>Please fill Bill Information</strong></p>
			<div>
                ...
                <div class="form-group">
                    <strong style="margin-left:5%;">PI DATE:</strong><input value="0"type="date" required name="pidate" style="margin-left:1%; " >
					      </div>
			...
			<tr>
				<td>Company name:</td>
				<td><input value="0"type="text" required name="comname1"></td>
				
			</tr>
			<tr>
				<td>Address:
<select name="countryCode" style="width:50%;">
  ...
  <option value="ZW">Zimbabwe</option>
				...
				<td><input value="0"type="text" required name="address1">
				<span>
				</td>
			...
			<tr>
				<td>Phone No:</td>
				<td><input value="0"type="text" required name="phone1"></td>
				
			</tr>
			<tr>
				<td>Mobile No:</td>
				<td><input value="0"type="text" required name="mobil1"></td>
				
			</tr>
			<tr>
				<td>Email:</td>
				<td><input value="0"type="email" required name="email1"></td>
	...
	<table class="table table-bordered table-striped">
			...
			<tr>
				...
				<td>Company name:</td>
				<td><input value="0"type="text" required name="comname2"></td>
			</tr>
			<tr>
				
				<td>Address: 
				
				<select name="countryCode2" style="width:50%;">
  <option value="AF">Afghanistan</option>
  <option value="AX">Åland Islands</option>
  <option value="AL">Albania</option>
  <option value="DZ">Algeria</option>
  ...
  <option value="ZW">Zimbabwe</option>
				...
				<td><input value="0"type="text" required name="address2"></td>
			</tr>
			<tr>
				
				<td>Phone No:</td>
				<td><input value="0"type="text" required name="phone2"></td>
			</tr>
			<tr>
				
				<td>Mobile No:</td>
				<td><input value="0"type="text" required name="mobil2"></td>
			</tr>
			<tr>
				
				<td>Email:</strong></td>
				<td><input value="0"type="email" required name="email2"></td>
			</tr>
		...
		<div class="table-responsive">
			...
			<tr>
  			<td>Delivery Time</td>
			<td><input value="0"type="text" required name="deliverytime"></td>
			<td></td>
			<td>Port of Loading</td>
			<td><input value="0"type="text" required name="loading"></td>
			</tr>

			<tr>
			<td>Country of origin of Goods</td>
			<td><input value="0"type="text" required name="originc"></td>
			<td></td>
			<td>Final Destination</td>
			<td><input value="0"type="text" required name="fdest"></td>
			</tr>

			<tr>
			<td>Port of Discharge</td>
			<td><input value="0"type="text" required name="discharge"></td>
			<td></td>
	...
	<table>
		<tbody>
			...
			<!--td>Deposit: <input value="0"type="text" required name="deposit" ></td>
			   <td></td>
			   <td>Balance Against B/L: </td>
			 <td><input value="0"type="text" required name="balbl" ></td-->
			</tr>
			<tr>
			<td id="td1">
			</td>
				...
				<b>Payment Against Delivery: <input value="0"type="text" required name="paydel" >
			</br></br>
				<b>Bank Information: 
				</br>
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<td><input value="0"type="text" required name="acchold" ></td>
						<td></td>
						<td>Bank Name: </td>
						<td><input value="0"type="text" required name="bankname" ></td>
						</tr>

						<tr>
						<td>Bank Institution Number: </td>
						<td><input value="0"type="text" required name="bankins" ></td>
						<td></td>
						<td>Branch / Transit Number: </td>
						<td><input value="0"type="text" required name="branchnum" ></td>
						</tr>

						<tr>
						<td>Branch Address: </td>
						<td><input value="0"type="address" required name="branchad" ></td>
						<td></td>
						<td>Branch Phone Number: </td>
						<td><input value="0"type="text" required name="branchph" ></td>
						</tr>

						<tr>
						<td>Branch Fax Number: </td>
						<td><input value="0"type="text" required name="branchfx" ></td>
						<td></td>
						<td>Account Number: </td>
						<td><input value="0"type="text" required name="accnum" ></td>
						</tr>

						<tr>
						<td>Bank Swift Code: </td>
						<td><input value="0"type="text" required name="banksw" ></td>
						<td></td>
						<td>Bank ABA / Routing Number: </td>
						<td><input value="0"type="text" required name="bankrn" ></td>
						</tr>
			...
			<p> Notes: </p>
			<input value="0"type="richtext" name="note" style="width:35%; height:60px;">
...
<script>
	...
	td1.innerHTML="Deposit: <input type='text' required name='deposit'/><input value='0' type='text' required name='balbl' hidden/>";
	$("#dep_bal").change(function () {
		selected = $(this).find("option:selected").text();
		if(selected=='Deposit')
		{
		td1.innerHTML="Deposit: <input value='0' type='text' required name='deposit' /> <input value='0' type='text' required name='balbl' hidden/>";
		}	
		else{
		td1.innerHTML="Balance Against B/L: <input value='0' type='text' required name='balbl' /> <input value='0' type='text' required name='deposit' hidden/> ";
		}
	});
</script>
